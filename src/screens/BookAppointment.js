  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.container}>
        ...
        <Text style={styles.heading}>Mai</Text>
              ...
              return (
                <TouchableOpacity
                  style={{
                    ...
                    alignItems: 'center',
                    backgroundColor: selectedDay == index ? 'rgb(51, 139, 147)' : 'white',
                  ...
                  <Text style={{ color: selectedDay == index ? '#fff' : 'rgb(51, 139, 147)' }}>
                    {item.day}
                  </Text>
                </TouchableOpacity>
              );
              ...
              return (
                <TouchableOpacity
                  style={[
                    styles.timeSlot,
                    {
                      borderColor: index == selectedSlot ? 'rgb(51, 139, 147)' : 'black',
                      backgroundColor: selectedSlot == index ? 'rgb(51, 139, 147)' : 'white',
                    },
                  ]}
                  onPress={() => {
                  ...
                  <Text
                    style={{ color: index == selectedSlot ? 'white' : 'black' }}>
                    {item.sloT}
                  </Text>
                </TouchableOpacity>
              );
        ...
        <View style={styles.genderView}>
          <TouchableOpacity
            style={[
              ...
              {
                borderWidth: 1,
                borderColor: selectedGender == 0 ? 'rgb(51, 139, 147)' : 'black',
                backgroundColor: selectedGender == 0 ? 'rgb(51, 139, 147)' : 'white',
              },
            ]}
            onPress={() => {
              setSelectedGender(0);
          ...
          <TouchableOpacity
            style={[
              ...
              {
                borderWidth: 1,
                borderColor: selectedGender == 1 ? 'rgb(51, 139, 147)' : 'black',
                backgroundColor: selectedGender == 1 ? 'rgb(51, 139, 147)' : 'white',
              },
            ]}
            onPress={() => {
              setSelectedGender(1);
